<template>
  ...
  >
    <div
      class="bg-white dark:bg-surface-section rounded-lg shadow-2xl w-full max-w-lg transform transition-all duration-300 scale-100"
    >
      <div
...
const title = computed(() =>
  props.item && props.item.id ? 'تعديل بيانات الخزان' : 'إضافة خزان جديد',
)
